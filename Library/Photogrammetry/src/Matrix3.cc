...
/*
--------------------------------------------------------------------------------
                    Return row or column as a vector
--------------------------------------------------------------------------------
*/

Vector3D Matrix3::Row(int i) const {
	Vector3D res(m[i][0], m[i][1], m[i][2]);
	return res;
}

Vector3D Matrix3::Column(int i) const {
	Vector3D res(m[0][i], m[1][i], m[2][i]);
	return res;
}
...
void Matrix3::Print(std::ostream &os) const {

	std::cerr << m[0][0] <<",  "<< m[0][1] <<",  "<< m[0][2] << std::endl;
	std::cerr << m[1][0] <<",  "<< m[1][1] <<",  "<< m[1][2] << std::endl;
	std::cerr << m[2][0] <<",  "<< m[2][1] <<",  "<< m[2][2] << std::endl;
}
