...
/*
--------------------------------------------------------------------------------
                        Sorting planes after plane number
--------------------------------------------------------------------------------
*/

int ComparePlaneNumbers(const void *plane1, const void *plane2)
{ return ((Plane *) plane1)->Number() -
         ((Plane *) plane2)->Number(); }

void Planes::Sort()
{
  qsort((void *) &*(this->begin()), this->size(), sizeof(Plane),
        ComparePlaneNumbers);
}
