...
------------------------------o00--(_)--00o------------------------------
  ...
  Dated         : 26 - Mar - 2005
  Modification  : Created two versions, one for inclusion in C programmes (this file)
                  and one for inclusion in C++ programmes (Database4Cpp.h)
...
extern FILE *Open_Compressed_File(const char *, const char *);
extern int Close_Compressed_File(FILE *);
extern char *Name_Compressed_File(const char *);
extern char *Name_Uncompressed_File(const char *);
extern int Compress_File(const char *, const char *, int);
...
extern ImgPts *Get_ImgPts(const char *filename);
extern int     Put_ImgPts(ImgPts *img_pts, const char *filename);
extern void    Print_ImgPts(const ImgPts *img_pts);
extern void    Free_ImgPts(ImgPts *img_pts);	

/*----------------------[ special functions ]--------------------------*/
extern int    ImgPts_Exist(ImgPt *img_pt, ImgPts *img_pts);
extern ImgPt *Search_ImgPts(ImgPt *img_pt, ImgPts *img_pts);
extern int    Delete_Pix(ImgPts *img_pts, int number);
...
extern CamPts *Get_CamPts(const char *filename);
extern int     Put_CamPts(CamPts *cam_pts, const char *filename);
extern void    Print_CamPts(const CamPts *cam_pts);
extern void    Free_CamPts(CamPts *cam_pts);
...
extern ObjPts *Get_ObjPts(const char *filename);
extern int     Put_ObjPts(ObjPts *obj_pts, const char *filename);
extern void    Print_ObjPts(const ObjPts *obj_pts);
extern void    Free_ObjPts(ObjPts *obj_pts);	

/*----------------[ general functions for ModelPts ]-------------------*/
extern ModelPts *Get_ModelPts(const char *filename);
extern int       Put_ModelPts(ModelPts *model_pts, const char *fname);
extern void      Print_ModelPts(const ModelPts *model_pts);
extern void      Free_ModelPts(ModelPts *model_pts);
...
extern CtrlPts *Get_CtrlPts(const char *filename);
extern int      Put_CtrlPts(CtrlPts *ctrl_pts, const char *filename);
extern void     Print_CtrlPts(const CtrlPts *ctrl_pts);
extern void     Free_CtrlPts(CtrlPts *ctrl_pts);
...
extern ImgLines *Get_ImgLines(const char *filename);
extern int       Put_ImgLines(ImgLines *img_lines, const char *filename);
extern void      Print_ImgLines(const ImgLines *img_lines);
extern void      Free_ImgLines(ImgLines *img_lines); 
...
/*-------------[ general functions for image lines ]------------------*/
extern LineTops *Get_LineTops(const char *filename);
extern int       Put_LineTops(LineTops *lines, const char *filename);
extern void      Print_LineTops(const LineTops *lines);
extern void      Free_LineTops(LineTops *lines);
...
/*----------------------[ general functions ]--------------------------*/
extern Interior *Get_Interior(const char *filename);
extern int       Put_Interior(const Interior *interior, const char *filename);
extern void      Print_Interior(const Interior *interior);
...
/*----------------------[ general functions ]--------------------------*/
extern Exterior *Get_Exterior(const char *filename, int *error);
extern int       Put_Exterior(const Exterior *, const char *);
extern void      Print_Exterior(const Exterior *exterior);

/*--------------------[ calculating functions ]------------------------*/
extern int Angles_From_Rot(Exterior *exterior);
extern int Rot_From_Angles(Exterior *exterior);

extern int Quat_From_Rot(Exterior *exterior);
extern int Rot_From_Quat(Exterior *exterior);

extern int Calculate_Rotation_Matrix(double, double, double, double mat[3][3]);
...
/*----------------------[ general functions ]--------------------------*/
extern int Get_Relative(const char *filename, Exterior *cam_1, Exterior *cam_2);
extern int Put_Relative(Exterior *cam_1, Exterior *cam_2, const char *filename);
...
/*----------------------[ general functions ]--------------------------*/
extern Absolute *Get_Absolute(const char *filename, int *error);
extern int       Put_Absolute(Absolute *absolute, const char *filename);
extern void      Print_Absolute(const Absolute *absolute);
...
/*----------------------[ general functions ]--------------------------*/
extern Grid   *Get_Grid(const char *filename);
extern int    Put_Grid(const Grid *grid, const char *filename);
...
extern ObjPts2D *Get_ObjPts2D(const char *filename);
extern int     Put_ObjPts2D(ObjPts2D *objpts2d, const char *filename);
extern void    Print_ObjPts2D(const ObjPts2D *objpts2d);
extern void    Free_ObjPts2D(ObjPts2D *objpts2d);	
...
/*----------------------[ general functions ]--------------------------*/
extern Grid3D   *Get_Grid3D(const char *filename);
extern int      Put_Grid3D(const Grid3D *grid, const char *filename);
extern void     Print_Grid3D(const Grid3D *grid);
...
extern Triangles *Get_Triangles(const char *filename);
extern int       Put_Triangles(const Triangles *tin, const char *filename);
extern void      Free_Triangles(Triangles *tin);
...
extern int Put_ProjTrans(const char *filename, double *parameters);
extern int Get_ProjTrans(const char *filename, double *parameters);
...
extern int Adjust(int, int, double *, double *, double *, double *,
