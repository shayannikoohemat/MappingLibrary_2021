...
extern "C" void Solve_Normal_Eq_Cholesky_Band(double *ata, double *aty, int np,
                                              int nb, int hbw);
extern "C" double * Allocate_Sparse_Band_Normal_Matrix(int np, int nb, int hbw);
extern "C" void Clear_Sparse_Band_Normal_Matrix(double *ata);
extern "C" void Free_Sparse_Band_Normal_Matrix(double *ata);
extern "C" void Update_Sparse_Band_Normal_Eq1(double *a, double y, double w, double *ata, 
                                              double *aty, int np, int nb, int hbw,
								              int start, int end);
extern "C" void Update_Sparse_Band_Normal_Eq2(double *a, double y, double w, double *ata, 
                                              double *aty, int np, int nb, int hbw,
								              int start1, int end1, int start2, int end2);
extern "C" void Update_Sparse_Band_Normal_Eq3(double *a, double y, double w, double *ata, 
                                              double *aty, int np, int nb, int hbw,
                                              int start1, int end1, int start2, int end2,
								              int start3, int end3);
extern "C" void Solve_Normal_Eq_Cholesky_Sparse_Band(double *ata, double *aty, int np,
                                                     int nb, int hbw);
extern "C" double * Sparse_ATA_Element(double *ata, int row, int column);
extern "C" double Sparse_ATA_Value(double *ata, int row, int column);
