...
extern void   BNF_Three_Doubles(const char *, double *, double *, double *);
...
extern void   BNF_Write_Three_Doubles(FILE *, const char *, int, double, double, double,
                                      const char *);
...
extern char   *DeriveDirectoryFromFile(const char *);
