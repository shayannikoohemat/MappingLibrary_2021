...
enum LaserPointTag { ReflectanceTag, PulseCountTag, LabelTag, IsFilteredTag,
		             ...
		             WeightTag, // Weight for a point in data processing
...
// Values to be used for point labels
enum LPClassLabel { LPUnclassifiedInvalid=-1, LPUnclassified=1, LPWall, LPFloor,
                  LPCeiling, LPDoor, LPWindow };
...
// Functions defined in the file LaserPoint.cc 
  ...
  public:
    ...
    /// Reinitialise a point, with deallocation of old attributes
    void ReInitialise();
