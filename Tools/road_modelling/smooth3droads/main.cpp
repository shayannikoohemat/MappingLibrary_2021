...
void PrintUsage()
{
  printf("Usage: smooth3droads  -ip <input map points (3D object points)>\n");
  printf("                    -it <input map topology (Map topology)>\n");
  printf("                    -op <output points (3D object points)>\n");
  printf("                    -ot <output topology>\n");
  printf("                    -ol <output laser points>\n");
...
int main(int argc, char *argv[])
{
  ...
  void SmoothRoads(char *, char *, char *, char *, char *);//, double);
  ...
  SmoothRoads(args->String("-ip"), args->String("-it"),
