...
void PrintUsage()
{
  printf("Usage: quality3dtop -ip <input map points (3D object points)>\n");
...
int main(int argc, char *argv[])
{
  ...
  void calculatequality3dtop(char *, char *, char *, char *, char *);
...
//      !args->Contains("-itr") ||
  ...
  calculatequality3dtop(args->String("-ip"), args->String("-it"),
