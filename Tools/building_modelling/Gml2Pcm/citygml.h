...
//	LIBCITYGML_EXPORT CityModel* load( std::istream& stream, const ParserParams& params );
	...
	public:
		...
		TVec3f computeNormal( void ) const;
	...
	class Polygon : public Object
	{
		...
		friend class CityModel;
	public:
		Polygon( const std::string& id ) : Object( id ), _indices( ),  _appearance( NULL ), _texCoords( ), _exteriorRing( ), _negNormal( false ) {}
	...
	///////////////////////////////////////////////////////////////////////////////
//	typedef enum GeometryType  // typedef enum is C, depreciated in C++
	enum GeometryType 
	{
		GT_Unknown = 0,
		GT_Roof,
