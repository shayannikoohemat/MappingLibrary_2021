...
void PrintUsage()
{
  printf("Usage: modeldrivenhypo  -ip <input map points (3D object points)>\n");
  ...
  printf("                    -d2f <max distance between 2 faces [default: 1.0 m]>\n");
...
int main(int argc, char *argv[])
{
  ...
  void modeldrivenhypo(char *, char *, char *, char *, char *, char *, char *, double);
  ...
  modeldrivenhypo(args->String("-ip"), args->String("-it"),
                            args->String("-itm"), args->String("-il"), 
                            args->String("-op"),
            args->String("-ot"), args->String("-info"), args->Double("-d2f", 1.0));
  return EXIT_SUCCESS;
}
