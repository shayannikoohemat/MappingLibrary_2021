...
LIBS += -L$(MAPPING_LIB_DIR) -lInferenceEngineLib -lBuildings -lLaserScan -llas -lPhotogrammetry -lEispack -lLinpack -lgfortran
LIBS += -L"d:/Dev-Cpp/lib" -lCGAL.dll -lgdal -lboost_system-mgw47-mt-1_62 -lboost_thread-mgw47-mt-1_62  -lmpfr -lgmp
LIBS += -lnewmat -lANN -lopengl32 -lglu32
...
INCLUDEPATH += . include  ../../../Library/LaserScan/include ../../../Library/Photogrammetry/include  ../../../Library/Buildings/include ../../../Foreign/ANN/include/ANN  ../InferenceEngineLib
