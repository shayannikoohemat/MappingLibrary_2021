...
void FittingParametersWindow::paintEvent(QPaintEvent *event)
{
  QPainter paint(this);
  int      y;
...
{
  if (strlen(new_slope_max.toLatin1().data()) == 0) return;
...
{
  if (strlen(new_slope_bin.toLatin1().data()) == 0) return;
...
{ if (strlen(new_max_dist_point_to_plane.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_dist_planes.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_angle_planes.toLatin1().data()) == 0) return;
...
{ if (strlen(new_max_angle_horizontal.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_dist_intersection_partition.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_angle_intersection_partition.toLatin1().data()) == 0) return;
...
{ if (strlen(new_max_dist_point_to_intersection.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_dist_height_jump_partition.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_angle_height_jump_partition.toLatin1().data()) == 0) return;
...
{ if (strlen(new_max_dist_point_to_height_jump.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_jump_height.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_partition_size.toLatin1().data()) == 0) return;
...
{ if (strlen(new_min_partition_percentage.toLatin1().data()) == 0) return;
