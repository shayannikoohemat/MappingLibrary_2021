...
// Menu for filtering operations
  ...
  filtering_menu->addAction(action);
	...
	//Create edit building topology graph tool bar
	CreateEditGraphToolBar();
////////////////////////////////////////////////////////////////////////////////
...
void PointCloudMapper::LoadSettings()
{
  ...
  if (!new_ini_file.isEmpty()) {
    ReadDefaults(new_ini_file.toLatin1());
...
void PointCloudMapper::SaveSettingsAs()
{
  ...
  WriteDefaults(filename.toLatin1());
...
*/
  ...
  printf("x: Clear selection of laser points\n");
...
*/
      ...
      case Qt::Key_T: // Decrease scale bar tick distance
        ...
        break;
      case Qt::Key_X: // Clear selection of laser points
