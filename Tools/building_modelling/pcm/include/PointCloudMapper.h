...
// User interface stuff
    ...
    /// Roof verification buttons
    QAction *roof_verification_button[3];
...
// Roof verification data

    /// Roof verification data file
    char *verification_file;

    /// Roof verification toolbar
    QToolBar *roof_verification_tools;
    
    /// Roof verification records
    vector <char *> roof_records;

    /// Current roof verification record
    int current_roof_record;
...
// Functions
  ...
  public:
    ...
    /// Load a roof verification data file
    void LoadRoofRecords(char *file_name);
  ...
  protected:
    ...
    /// Handle a decision on a roof verification
    void RoofVerification(int decision, bool move_to_next);
  ...
  private slots:
    ...
    /// Save roof verification records
    void SaveRoofRecords();
    
    /// Save roof verification records in different file
    void SaveRoofRecordsAs();
    
    /// Select a roof verification data file
    void SelectRoofVerificationFile();
    ...
    /// Accept an extracted roof
    void RoofAccepted()
      { RoofVerification(0, true); }
      
    /// Leave verification of a roof undecided
    void RoofUndecided()
      { RoofVerification(1, true); }
      
    /// Reject an extracted roof
    void RoofRejected()
      { RoofVerification(2, true); }
      
    /// Load the next roof with undecided status
    void NextUndecidedRoof();
};
