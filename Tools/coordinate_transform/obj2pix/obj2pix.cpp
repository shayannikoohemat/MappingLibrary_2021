...
extern "C" int obj2pix_c(char *, char *, char *);

void PrintUsage()
{
  printf("Transformation of 3D object points into an image coordinate system.\n\n");
...
int main(int argc, char *argv[])
{
  ...
  if (!args->Contains("-i")) {
    printf("Error: 3D Object points should be specified with -i\n");
    PrintUsage();
    return EXIT_SUCCESS;
  }
  if (!args->Contains("-o")) {
  ...
  // Call the obj2pix C routine
  obj2pix_c(args->String("-i"), args->String("-o"), args->String("-g"));
