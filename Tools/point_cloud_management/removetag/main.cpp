...
void PrintUsage()
{
  printf("Usage: removetag -i <meta file or point file> OR\n");
  printf("                 -f <file filter>\n");
  printf("                 -t <tag index to be removed\n");
  printf("                 -t2 <tag index to be removed\n");
  printf("                 -t3 <tag index to be removed\n");
  printf("                 -t4 <tag index to be removed\n");
  printf("                 -t5 <tag index to be removed\n\n");
  printf("Note that the input files will be overwritten\n\n");
  printf("Possible tag numbers are:\n");
  ...
  printf("  SegmentStartTileNumberTag %d\n", SegmentStartTileNumberTag);
...
int main(int argc, char *argv[])
{
  ...
  void removetag_cpp(char *, char *, int, int, int, int, int);
  ...
  removetag_cpp(args->String("-f"), args->String("-i"),
                args->Integer("-t", -1),
                args->Integer("-t2", -1), args->Integer("-t3", -1),
                args->Integer("-t4", -1), args->Integer("-t5", -1));
