...
int main(int argc, char *argv[])
{
  ...
  void IndoorSLAMProcess(char *, char *, char *, char *, char *, char *, char *,
                         char *, char *, int, char *, double, double, bool,
						 double,char *, bool, char *, double, double, bool,
						 bool, int, int);
  ...
  IndoorSLAMProcess(args->String("-b"), args->String("-i0"), args->String("-i1"),
                    args->String("-i2"), args->String("-imu"),
					args->String("-rapp"), args->String("-t"),
